...
# from constrained_decoding import BatchSchemaConstrainedLogitsProcessor
...
#                 db_paths = [m[2] for m in batch_meta]
#                 logits_processor = LogitsProcessorList([BatchSchemaConstrainedLogitsProcessor(tokenizer, db_paths)])
...
#             print("Constraint OK:", constraint_ok_count,"/",total_seen)
#             if total_seen > 0:
#                 print("Constraint Satisfaction Rate:", round(constraint_ok_count/total_seen,3))
